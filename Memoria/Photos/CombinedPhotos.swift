...
//
//                                                    } else {
//                                                        Color.clear.frame(minWidth: 0, maxWidth: .infinity, minHeight: 0, idealHeight: 130, maxHeight: .infinity, alignment: .center)
//                                                    }
//
//                                                }
//                                            }
...
////                                .matchedGeometryEffect(id: self.selectedItem!.id, in: nspace, properties: .frame)
////                        )
////                        .zIndex(3)
////                        .transition(.modal)
////                    }
